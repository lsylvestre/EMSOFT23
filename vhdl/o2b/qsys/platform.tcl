...
add_instance button altera_avalon_pio 20.1
set_instance_parameter_value button {bitClearingEdgeCapReg} {0}
set_instance_parameter_value button {bitModifyingOutReg} {0}
set_instance_parameter_value button {captureEdge} {0}
set_instance_parameter_value button {direction} {Input}
set_instance_parameter_value button {edgeType} {RISING}
set_instance_parameter_value button {generateIRQ} {0}
set_instance_parameter_value button {irqType} {LEVEL}
set_instance_parameter_value button {resetValue} {0.0}
set_instance_parameter_value button {simDoTestBenchWiring} {0}
set_instance_parameter_value button {simDrivenValue} {0.0}
set_instance_parameter_value button {width} {2}

add_instance hex0 altera_avalon_pio 20.1
set_instance_parameter_value hex0 {bitClearingEdgeCapReg} {0}
set_instance_parameter_value hex0 {bitModifyingOutReg} {0}
set_instance_parameter_value hex0 {captureEdge} {0}
set_instance_parameter_value hex0 {direction} {Output}
set_instance_parameter_value hex0 {edgeType} {RISING}
set_instance_parameter_value hex0 {generateIRQ} {0}
set_instance_parameter_value hex0 {irqType} {LEVEL}
set_instance_parameter_value hex0 {resetValue} {0.0}
set_instance_parameter_value hex0 {simDoTestBenchWiring} {0}
set_instance_parameter_value hex0 {simDrivenValue} {0.0}
set_instance_parameter_value hex0 {width} {8}

add_instance hex1 altera_avalon_pio 20.1
set_instance_parameter_value hex1 {bitClearingEdgeCapReg} {0}
set_instance_parameter_value hex1 {bitModifyingOutReg} {0}
set_instance_parameter_value hex1 {captureEdge} {0}
set_instance_parameter_value hex1 {direction} {Output}
set_instance_parameter_value hex1 {edgeType} {RISING}
set_instance_parameter_value hex1 {generateIRQ} {0}
set_instance_parameter_value hex1 {irqType} {LEVEL}
set_instance_parameter_value hex1 {resetValue} {0.0}
set_instance_parameter_value hex1 {simDoTestBenchWiring} {0}
set_instance_parameter_value hex1 {simDrivenValue} {0.0}
set_instance_parameter_value hex1 {width} {8}

add_instance hex2 altera_avalon_pio 20.1
set_instance_parameter_value hex2 {bitClearingEdgeCapReg} {0}
set_instance_parameter_value hex2 {bitModifyingOutReg} {0}
set_instance_parameter_value hex2 {captureEdge} {0}
set_instance_parameter_value hex2 {direction} {Output}
set_instance_parameter_value hex2 {edgeType} {RISING}
set_instance_parameter_value hex2 {generateIRQ} {0}
set_instance_parameter_value hex2 {irqType} {LEVEL}
set_instance_parameter_value hex2 {resetValue} {0.0}
set_instance_parameter_value hex2 {simDoTestBenchWiring} {0}
set_instance_parameter_value hex2 {simDrivenValue} {0.0}
set_instance_parameter_value hex2 {width} {8}

add_instance hex3 altera_avalon_pio 20.1
set_instance_parameter_value hex3 {bitClearingEdgeCapReg} {0}
set_instance_parameter_value hex3 {bitModifyingOutReg} {0}
set_instance_parameter_value hex3 {captureEdge} {0}
set_instance_parameter_value hex3 {direction} {Output}
set_instance_parameter_value hex3 {edgeType} {RISING}
set_instance_parameter_value hex3 {generateIRQ} {0}
set_instance_parameter_value hex3 {irqType} {LEVEL}
set_instance_parameter_value hex3 {resetValue} {0.0}
set_instance_parameter_value hex3 {simDoTestBenchWiring} {0}
set_instance_parameter_value hex3 {simDrivenValue} {0.0}
set_instance_parameter_value hex3 {width} {8}

add_instance hex4 altera_avalon_pio 20.1
set_instance_parameter_value hex4 {bitClearingEdgeCapReg} {0}
set_instance_parameter_value hex4 {bitModifyingOutReg} {0}
set_instance_parameter_value hex4 {captureEdge} {0}
set_instance_parameter_value hex4 {direction} {Output}
set_instance_parameter_value hex4 {edgeType} {RISING}
set_instance_parameter_value hex4 {generateIRQ} {0}
set_instance_parameter_value hex4 {irqType} {LEVEL}
set_instance_parameter_value hex4 {resetValue} {0.0}
set_instance_parameter_value hex4 {simDoTestBenchWiring} {0}
set_instance_parameter_value hex4 {simDrivenValue} {0.0}
set_instance_parameter_value hex4 {width} {8}

add_instance hex5 altera_avalon_pio 20.1
set_instance_parameter_value hex5 {bitClearingEdgeCapReg} {0}
set_instance_parameter_value hex5 {bitModifyingOutReg} {0}
set_instance_parameter_value hex5 {captureEdge} {0}
set_instance_parameter_value hex5 {direction} {Output}
set_instance_parameter_value hex5 {edgeType} {RISING}
set_instance_parameter_value hex5 {generateIRQ} {0}
set_instance_parameter_value hex5 {irqType} {LEVEL}
set_instance_parameter_value hex5 {resetValue} {0.0}
set_instance_parameter_value hex5 {simDoTestBenchWiring} {0}
set_instance_parameter_value hex5 {simDrivenValue} {0.0}
set_instance_parameter_value hex5 {width} {8}

add_instance led altera_avalon_pio 20.1
...
add_instance switch altera_avalon_pio 20.1
...
set_instance_parameter_value switch {width} {10}

add_connection clk.clk button.clk clock

add_connection clk.clk hex0.clk clock

add_connection clk.clk hex1.clk clock

add_connection clk.clk hex2.clk clock

add_connection clk.clk hex3.clk clock

add_connection clk.clk hex4.clk clock

add_connection clk.clk hex5.clk clock

add_connection clk.clk led.clk clock

add_connection clk.clk switch.clk clock
add_connection cpu.data_master button.s1 avalon
set_connection_parameter_value cpu.data_master/button.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/button.s1 baseAddress {0x04041090}
set_connection_parameter_value cpu.data_master/button.s1 defaultConnection {0}

add_connection cpu.data_master hex0.s1 avalon
set_connection_parameter_value cpu.data_master/hex0.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/hex0.s1 baseAddress {0x04041070}
set_connection_parameter_value cpu.data_master/hex0.s1 defaultConnection {0}

add_connection cpu.data_master hex1.s1 avalon
set_connection_parameter_value cpu.data_master/hex1.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/hex1.s1 baseAddress {0x04041060}
set_connection_parameter_value cpu.data_master/hex1.s1 defaultConnection {0}

add_connection cpu.data_master hex2.s1 avalon
set_connection_parameter_value cpu.data_master/hex2.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/hex2.s1 baseAddress {0x04041050}
set_connection_parameter_value cpu.data_master/hex2.s1 defaultConnection {0}

add_connection cpu.data_master hex3.s1 avalon
set_connection_parameter_value cpu.data_master/hex3.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/hex3.s1 baseAddress {0x04041040}
set_connection_parameter_value cpu.data_master/hex3.s1 defaultConnection {0}

add_connection cpu.data_master hex4.s1 avalon
set_connection_parameter_value cpu.data_master/hex4.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/hex4.s1 baseAddress {0x04041030}
set_connection_parameter_value cpu.data_master/hex4.s1 defaultConnection {0}

add_connection cpu.data_master hex5.s1 avalon
set_connection_parameter_value cpu.data_master/hex5.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/hex5.s1 baseAddress {0x04041020}
set_connection_parameter_value cpu.data_master/hex5.s1 defaultConnection {0}

add_connection cpu.data_master led.s1 avalon
set_connection_parameter_value cpu.data_master/led.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/led.s1 baseAddress {0x040410a0}
set_connection_parameter_value cpu.data_master/led.s1 defaultConnection {0}

add_connection cpu.data_master switch.s1 avalon
set_connection_parameter_value cpu.data_master/switch.s1 arbitrationPriority {1}
set_connection_parameter_value cpu.data_master/switch.s1 baseAddress {0x04041080}
set_connection_parameter_value cpu.data_master/switch.s1 defaultConnection {0}

add_connection cpu.debug_reset_request button.reset reset
add_connection cpu.debug_reset_request hex0.reset reset
add_connection cpu.debug_reset_request hex1.reset reset
add_connection cpu.debug_reset_request hex2.reset reset
add_connection cpu.debug_reset_request hex3.reset reset
add_connection cpu.debug_reset_request hex4.reset reset
add_connection cpu.debug_reset_request hex5.reset reset
add_connection cpu.debug_reset_request led.reset reset
add_connection cpu.debug_reset_request switch.reset reset

add_interface button_external_connection conduit end
set_interface_property button_external_connection EXPORT_OF button.external_connection
add_interface hex0_external_connection conduit end
set_interface_property hex0_external_connection EXPORT_OF hex0.external_connection
add_interface hex1_external_connection conduit end
set_interface_property hex1_external_connection EXPORT_OF hex1.external_connection
add_interface hex2_external_connection conduit end
set_interface_property hex2_external_connection EXPORT_OF hex2.external_connection
add_interface hex3_external_connection conduit end
set_interface_property hex3_external_connection EXPORT_OF hex3.external_connection
add_interface hex4_external_connection conduit end
set_interface_property hex4_external_connection EXPORT_OF hex4.external_connection
add_interface hex5_external_connection conduit end
set_interface_property hex5_external_connection EXPORT_OF hex5.external_connection
...
add_interface switch_external_connection conduit end
set_interface_property switch_external_connection EXPORT_OF switch.external_connection
